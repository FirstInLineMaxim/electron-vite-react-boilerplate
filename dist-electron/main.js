...
const path$c = require("node:path");
...
const createWindow = () => {
  win = new electron.BrowserWindow({
    ...
    icon: path$c.join(__dirname, "trayIcon.png"),
    webPreferences: {
  ...
  const iconPath = path$c.join(__dirname, "trayIcon.png");
...
electron.app.whenReady().then(() => {
  ...
  electron.ipcMain.handle("openMenu", async (event) => {
    ...
    const videoOptionsMenu = electron.Menu.buildFromTemplate(
